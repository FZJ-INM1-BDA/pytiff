...
#define __PYX_HAVE__tiff
#define __PYX_HAVE_API__tiff
#include "tifftile.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'tiff' */
#define __Pyx_MODULE_NAME "tiff"
int __pyx_module_is_main_tiff = 0;

/* Implementation of 'tiff' */
 ...
 * cimport ctiff
 * 
 * cdef samples_per_pixel(char* name):             # <<<<<<<<<<<<<<
 *   return ctiff.get_samples_per_pixel(name)
 */

static PyObject *__pyx_f_4tiff_samples_per_pixel(char *__pyx_v_name) {
 ...
 */
  ...
  __Pyx_AddTraceback("tiff.samples_per_pixel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittiff(void); /*proto*/
PyMODINIT_FUNC inittiff(void)
#else
PyMODINIT_FUNC PyInit_tiff(void); /*proto*/
PyMODINIT_FUNC PyInit_tiff(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_tiff(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("tiff", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_tiff) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "tiff")) {
      if (unlikely(PyDict_SetItemString(modules, "tiff", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init tiff", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init tiff");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
